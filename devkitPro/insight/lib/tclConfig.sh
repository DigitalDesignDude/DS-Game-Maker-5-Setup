...
# installed.
TCL_PREFIX='c:/devkitPro/insight'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='c:/devkitPro/insight'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/d/projects/devkitPro/test/build/powerpc-gekko/insight/tcl/win -ltcl84'
...
TCL_INCLUDE_SPEC='-Ic:/devkitPro/insight/include'
...
# compiled.
TCL_SRC_DIR='/d/projects/devkitPro/test/insight-cvs/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/d/projects/devkitPro/test/build/powerpc-gekko/insight/tcl/win -ltclstub84'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lc:/devkitPro/insight/lib -ltclstub84'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/d/projects/devkitPro/test/build/powerpc-gekko/insight/tcl/win/libtclstub84.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='c:/devkitPro/insight/lib/libtclstub84.a'
