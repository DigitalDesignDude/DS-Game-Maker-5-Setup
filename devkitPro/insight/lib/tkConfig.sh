...
# installed.
TK_PREFIX='c:/devkitPro/insight'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='c:/devkitPro/insight'

# -I switch(es) to use to make all of the X11 include files accessible:
TK_XINCLUDES='-I"/d/projects/devkitPro/test/insight-cvs/tk/xlib"'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/d/projects/devkitPro/test/build/powerpc-gekko/insight/tk/win -ltk84'
...
# compiled.
TK_SRC_DIR='/d/projects/devkitPro/test/insight-cvs/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/d/projects/devkitPro/test/build/powerpc-gekko/insight/tk/win -ltkstub84'
